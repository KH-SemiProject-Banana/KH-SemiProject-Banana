const click =  document.getElementById("click"); // 1페이지
const click1 = document.getElementById("click1"); // 2페이지
const click2 = document.getElementById("click2"); // 2페이지
const click3 = document.getElementById("click3"); // 2페이지
const click4 = document.getElementById("click4"); // 2페이지
const click5 = document.getElementById("click5"); // 2페이지
const click6 = document.getElementById("click6"); // 2페이지
