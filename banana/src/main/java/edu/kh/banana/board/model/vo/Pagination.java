...
private int pageSize = 10;      // (페이지 하단에) 보여질 페이지 번호 개수
...
private void makePagination() {
   ...
   // ex) 13페이지가 마지막일 경우 endPage = 20이 아니라 13
   if(endPage > maxPage) {
      endPage = maxPage;
   }
   
   
   // prevPage : 이전 페이지네이션 목록의 끝 번호(< 기호)
   // nextPage : 다음 페이지네이션 목록의 시작 번호(> 기호)
