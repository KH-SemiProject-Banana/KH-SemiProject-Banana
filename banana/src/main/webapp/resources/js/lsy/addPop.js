...
document.getElementById("goodchoiceLabel").addEventListener("click", function(){
    document.getElementById("goodchoiceLabel").style.border = "3px solid #e53095";
    
    document.getElementById("badchoiceLabel").style.border = "2px solid #ccc";


})
document.getElementById("badchoiceLabel").addEventListener("click", function(){
    document.getElementById("badchoiceLabel").style.border = "3px solid #e53095";
...
document.getElementById("finalPopUp").addEventListener("click",function(){
    ...
    $.ajax({
        ...
        success : (reviewList) => {
            ...
            //----------------------------------------------------
            document.querySelector("#messageList2").innerHTML = "";
