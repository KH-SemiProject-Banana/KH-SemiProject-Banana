...
<body>
    ...
    <jsp:include page="/WEB-INF/views/common/header.jsp" />
        ...
        <section class="goods-register">
            ...
            <form name="register__content" id="register__content"  method="post"  enctype="multipart/form-data" onsubmit="return submitChk()">
							...
							<div class="image-upload" id="image-upload">
								...
								<div class="button">
									<label for="chooseFile"> <img
										src="images/image-upload.png" class="browse-btn">
									</label>
								</div>
								<input type="file" id="chooseFile" name="chooseFile"
									accept="image/*" onchange="return loadFile(this)" multiple />
				...
				<div class="content-title">
                    ...
                    <div class="content-title__content right-bar">
                        <input type="text" placeholder="상품 제목을 입력해주세요" name="goods-title" id="goodsTitle">
                ...
                <div class="content-category">
                    ...
                    <div class="content-category__content right-bar">
                        <select name="goods-category" id="goodsCategory">
                ...
                <div class="content-discription">
                    ...
                    <div class="content-discription__content right-bar">
                        <textarea row="5" col="30" class="introduce" id="goodsContent"
                ...
                <div class="content-delivery">
                    ...
                    <div class="content-price__content right-bar">
                        <input type="text" placeholder="판매 금액을 입력해주세요(단위 : 원)" name="goods-price" id="goodsPrice">
